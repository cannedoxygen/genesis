...
// Mock NFT Storage client for IPFS uploads
let nftStorageClient = null;

// Simplified GenesisNFT ABI with just the methods we need
const GenesisNFTABI = [
  // Read functions
...
export function generateNFTMetadata(gameData) {
  ...
  return {
    ...
    image: "/assets/images/rewards/default-nft.png", // Use local image instead of IPFS
...
export async function generateNFTImage(gameData) {
  try {
    ...
    return new Blob(['error image data'], { type: 'image/png' });
  }
}
